          ...
          <Col md={6}>
            <div className="glass-card" style={{ padding: '40px' }}>
              ...
              <p style={{ lineHeight: 1.8, color: '#4a0e2e' }}>
                Olá! Sou a Ana Caroline, tosadora profissional com paixão por animais.
                Meu objetivo é proporcionar uma experiência positiva e relaxante para
                seu pet, sempre com muito cuidado, paciência e amor.
              </p>
              <p style={{ lineHeight: 1.8, color: '#4a0e2e', marginTop: '15px' }}>
